...
gust_intensity_range = np.arange(0.3,1.2,0.3)
gust_length_range =  np.arange(0.25,2.0,0.25)

gust_intensity_range = np.arange(0.1,0.9,0.2)
gust_length_range =  np.arange(0.3,2.1,0.3)
case_name_root='HALE_strong'
