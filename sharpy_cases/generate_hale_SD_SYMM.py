...
impulse_intensity = [100,150,200]
#impulse_nodes=  [[1,9],[3,11],[5,13],[7,15]]
#impulse_type=  ['SYMM','SYMM','SYMM','SYMM','SYMM','SYMM']

#impulse_nodes=  [[17],[19],[21],[23],[25,29],[27,31]]
#impulse_type=  ['SYMM','SYMM','SYMM','SYMM','SYMM','SYMM']

#impulse_nodes=  [[1,9],[3,11],[5,13],[7,15],[17],[19],[21],[23],[25,29],[27,31]]

impulse_nodes=  [[26,27,28,30,31,32]] #[6,7,8,14,15,16],


case_name_root='HALE_SD_SYMM_TAIL_v2'
route = '/home/dmsm/m.colombo/Documents/sharpy/data/'+case_name_root+'/'
os.makedirs(route,exist_ok=True)

for impulse_intensity_input in impulse_intensity :
    for impulse_nodes_input in impulse_nodes :
        case_name = case_name_root+'_INT'+str(impulse_intensity_input)+'N'+str(impulse_nodes_input[0])
        ...
        itend_deflection= itstart_deflection+int(20/tstep_factor)
