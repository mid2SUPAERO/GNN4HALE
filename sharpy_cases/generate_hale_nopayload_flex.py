...
gust_intensity_range = np.arange(0.3,1.8,0.3)
gust_length_range =  np.arange(0.5,2.5,0.5)
case_name_root='HALE_nopayload_flex3'
...
for gust_intensity_input in gust_intensity_range :
    for gust_length_input in gust_length_range :
        ...
        case_name = case_name_root+'i'+np.array2string(gust_intensity_input, precision=2)+'l'+np.array2string(gust_length_input, precision=2)
